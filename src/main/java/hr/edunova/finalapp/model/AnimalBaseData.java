...
@Entity
public class AnimalBaseData extends Entitet{
    ...
    private int nativityId; //if exist in table
    ...
    public int getNativityId() {
        return nativityId;
    }

    public void setNativityId(int nativityId) {
        this.nativityId = nativityId;
    }
